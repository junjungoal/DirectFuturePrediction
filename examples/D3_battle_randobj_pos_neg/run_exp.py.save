...
def main(main_args):
    ...
    train_experience_args['memory_capacity'] = 400000
    ...
    # agent_args['objective_coeffs_meas'] = [1., 1., -1.]
    # agent_args['objective_coeffs_meas'] = [1e-5, 1e-5, 1.]
    # agent_args['objective_coeffs_meas'] = [1e-5, 1., 1e-5]
    agent_args['objective_coeffs_meas'] = [1., 1e-5, 1e-5]
    ...
    # experiment_args['test_objective_coeffs_meas'] = np.array([1.,1., -1.])
    # experiment_args['test_objective_coeffs_meas'] = np.array([1e-5,1e-5, 1.])
    # experiment_args['test_objective_coeffs_meas'] = np.array([1e-5,1., 1e-5])
    experiment_args['test_objective_coeffs_meas'] = np.array([1.,1e-5, 1e-5])
    experiment_args['test_random_prob'] = 0.
    experiment_args['test_checkpoint'] = 'checkpoints/2017_04_09_09_13_17'
    # experiment_args['test_policy_num_steps'] = 40000
